    ...
    <tr className="hover:bg-gray-50">
      <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
        ...
        <div className="text-sm">
          <div className="font-medium text-gray-700">{props.task.title}</div>
          <div className="text-gray-400">{props.task.description}</div>
        </div>
      </th>
      ...
      <td className="px-6 py-4">{props.task.due_date}</td>
      <td className="px-6 py-4">
